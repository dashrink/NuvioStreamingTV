...
data class Profile (
     ...
     */
    var `maturityRating`: kotlin.String?
...
public object FfiConverterTypeProfile: FfiConverterRustBuffer<Profile> {
    ...
    override fun allocationSize(value: Profile) = (
            ...
            FfiConverterBoolean.allocationSize(value.`isKids`) +
            FfiConverterOptionalString.allocationSize(value.`pin`) +
            FfiConverterOptionalString.allocationSize(value.`language`) +
            FfiConverterOptionalBoolean.allocationSize(value.`autoplayNext`) +
            FfiConverterOptionalString.allocationSize(value.`maturityRating`)
    )
    ...
    override fun write(value: Profile, buf: ByteBuffer) {
            ...
            FfiConverterBoolean.write(value.`isKids`, buf)
            FfiConverterOptionalString.write(value.`pin`, buf)
            FfiConverterOptionalString.write(value.`language`, buf)
            FfiConverterOptionalBoolean.write(value.`autoplayNext`, buf)
            FfiConverterOptionalString.write(value.`maturityRating`, buf)
    }
}
...
public object FfiConverterTypeNuvioError : FfiConverterRustBuffer<NuvioException> {
    override fun read(buf: ByteBuffer): NuvioException {
        ...
        return when(buf.getInt()) {
            ...
            3 -> NuvioException.Unknown(
                FfiConverterString.read(buf),
                )
            4 -> NuvioException.NetworkException(
                FfiConverterString.read(buf),
                )
            5 -> NuvioException.Timeout(
                FfiConverterString.read(buf),
                )
            6 -> NuvioException.AddonNotFound(
                FfiConverterString.read(buf),
                )
            7 -> NuvioException.InvalidManifest(
                FfiConverterString.read(buf),
                )
            8 -> NuvioException.ResponseTooLarge(
    ...
    override fun allocationSize(value: NuvioException): ULong {
        return when(value) {
            ...
            is NuvioException.AddonNotFound -> (
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                4UL
                + FfiConverterString.allocationSize(value.`addonId`)
            )
    ...
    override fun write(value: NuvioException, buf: ByteBuffer) {
        when(value) {
            ...
            is NuvioException.AddonNotFound -> {
                buf.putInt(6)
                FfiConverterString.write(value.`addonId`, buf)
                Unit
            }
            is NuvioException.InvalidManifest -> {
                buf.putInt(7)
