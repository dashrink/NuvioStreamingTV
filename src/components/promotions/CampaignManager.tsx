        ...
        <View style={styles.bannerContent}>
          {content.title && (
            <Text
              style={[
                styles.bannerTitle,
                { color: content.textColor || '#fff', fontSize: isTablet ? 16 : 14 },
              ]}
            >
              {content.title}
            </Text>
          ...
          {content.message && (
            <Text
              style={[
                ...
                { color: content.textColor || '#fff', fontSize: isTablet ? 14 : 12 },
              ]}
              numberOfLines={2}
            >
              {content.message}
          ...
          >
            <Text
              style={[
                ...
                { color: content.backgroundColor || '#1a1a1a', fontSize: isTablet ? 14 : 12 },
              ]}
            >
              {content.primaryAction.label}
            </Text>
          ...
          {content.title && (
            <Text
              style={[
                ...
                { color: content.textColor || '#fff', fontSize: isTablet ? 24 : 20 },
              ]}
            >
              {content.title}
            </Text>
        ...
        {content.primaryAction && (
          <TouchableOpacity
            style={[
              ...
              { backgroundColor: content.textColor || '#fff', paddingVertical: isTablet ? 16 : 14 },
            ]}
          ...
          >
            <Text
              style={[
                ...
                { color: content.backgroundColor || '#1a1a1a', fontSize: isTablet ? 17 : 15 },
              ]}
            >
              {content.primaryAction.label}
            </Text>
  ...
  return (
    <View style={StyleSheet.absoluteFill} pointerEvents="box-none">
      {activeCampaign.type === 'poster_modal' && (
        <PosterModal campaign={activeCampaign} onDismiss={handleDismiss} onAction={handleAction} />
      )}
