...
const TraktRatingModal: React.FC<TraktRatingModalProps> = memo(
  ({ visible, onClose, imdbId, type, contentTitle, onRatingSubmit, onRatingClear }) => {
      ...
      >
        <View style={styles.overlay}>
          ...
          >
            ...
            {currentRating !== null && (
              <View
                style={[styles.currentRatingBadge, { backgroundColor: 'rgba(237, 28, 36, 0.15)' }]}
              >
            ...
            <View style={styles.ratingContainer}>
              <View style={styles.ratingButtonsRow}>{renderRatingButtons().slice(0, 5)}</View>
              <View style={styles.ratingButtonsRow}>{renderRatingButtons().slice(5, 10)}</View>
            </View>
            ...
            <View style={styles.actionsContainer}>
              ...
              <TouchableOpacity
                ...
                style={[
                  ...
                  {
                    backgroundColor:
                      selectedRating !== null ? traktColors.primary : 'rgba(255,255,255,0.1)',
