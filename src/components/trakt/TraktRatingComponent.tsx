    ...
    <View style={[styles.container, style]}>
      {showLabel && (
        <View style={styles.labelContainer}>
          <Text style={[styles.label, { color: currentTheme.colors.textMuted, fontSize: sizeConfig.labelSize }]}>
            Your Rating
          </Text>
          {currentRating !== null && (
            <Text style={[styles.ratingValue, { color: traktColors.primary, fontSize: sizeConfig.labelSize }]}>
              {currentRating}/10
            </Text>
          )}
        </View>
