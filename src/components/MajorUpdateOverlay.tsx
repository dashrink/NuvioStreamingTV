      ...
      <View style={styles.backdrop}>
        ...
        >
          <View style={styles.header}>
            <View
              style={[styles.iconCircle, { backgroundColor: `${currentTheme.colors.primary}22` }]}
            >
            ...
            {!!latestTag && (
              <Text style={[styles.version, { color: currentTheme.colors.mediumEmphasis }]}>
                Latest: {latestTag}
              </Text>
            )}
          </View>
          ...
          <View style={styles.actions}>
            ...
            <View style={styles.secondaryRow}>
              <TouchableOpacity
                style={[styles.secondaryBtn, { borderColor: currentTheme.colors.elevation3 }]}
                onPress={onLater}
              >
                <Text style={[styles.secondaryText, { color: currentTheme.colors.mediumEmphasis }]}>
                  Later
                </Text>
              </TouchableOpacity>
              <TouchableOpacity
