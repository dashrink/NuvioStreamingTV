...
const SubtitleRow = React.memo(
  ({
    ...
    useEffect(() => {
      opacity.value = withTiming(isCurrent ? 1 : Math.max(0.3, 0.8 - Math.abs(position) * 0.2), {
        duration: 200,
      });
    ...
    return (
      <Animated.View layout={Layout.duration(200)} style={styles.subtitleRow}>
        <Animated.View style={animatedStyle}>
          <Animated.Text style={[styles.subtitleText, animatedTextStyle]} numberOfLines={2}>
            {cue.text}
          </Animated.Text>
        </Animated.View>
      </Animated.View>
        ...
        {Platform.OS === 'android' && AndroidBlurView ? (
          ...
          >
            ...
            <View style={styles.offsetContainer}>
              <Text style={[styles.offsetLabel, isLargeScreen && styles.offsetLabelLarge]}>
                Delay
              </Text>
              <Text
                style={[
            ...
            <View style={styles.resetBtnContainer}>
              <TouchableOpacity
                onPress={handleReset}
                style={[styles.resetBtn, isLargeScreen && styles.resetBtnLarge]}
                activeOpacity={0.7}
              >
                <MaterialIcons
                  name="refresh"
                  ...
                  style={{ marginRight: 4 }}
                />
                <Text style={[styles.resetBtnText, isLargeScreen && styles.resetBtnTextLarge]}>
                  Reset
                </Text>
              </TouchableOpacity>
            </View>
            ...
            <View style={[styles.buttons, isLargeScreen && { gap: 16 }]}>
              ...
              <TouchableOpacity
                style={[styles.cancelBtn, isLargeScreen && styles.btnLarge]}
                onPress={onClose}
                activeOpacity={0.7}
              >
                <Text style={[styles.cancelBtnText, isLargeScreen && styles.btnTextLarge]}>
                  CANCEL
                </Text>
              </TouchableOpacity>
            </View>
