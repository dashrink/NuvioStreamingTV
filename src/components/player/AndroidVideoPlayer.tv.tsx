...
import { View, StyleSheet, Platform, Animated, ToastAndroid, Dimensions, StatusBar, NativeModules } from 'react-native';
...
import { WyzieSubtitle, SubtitleCue, ResizeModeType, AudioTrack, TextTrack } from './utils/playerTypes';
...
const AndroidVideoPlayer: React.FC = () => {
  ...
  const {
    ...
    availableStreams: passedAvailableStreams, backdrop, groupedEpisodes, initialPosition
  } = route.params as any;
  ...
  const [subtitleLineHeightMultiplier, setSubtitleLineHeightMultiplier] = subtitleLineHeightMultiplierState;
  ...
  }, [playerState.paused, playerState.setPaused, playerState.setShowControls, resetTVControlsTimeout]);
