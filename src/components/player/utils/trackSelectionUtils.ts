 ...
 */
export const findBestAudioTrack = (tracks: Track[], preferredLanguage: string): number | null => {
 ...
 */
export const autoSelectAudioTrack = (tracks: Track[], preferredLanguage: string): number | null => {
  if (!tracks || tracks.length === 0) return null;
