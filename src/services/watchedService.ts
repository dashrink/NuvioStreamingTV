...
class WatchedService {
  ...
  public async markEpisodeAsWatched(
    ...
    try {
      logger.log(
        `[WatchedService] Marking episode as watched: ${showImdbId} S${season}E${episode}`
      );
  ...
  public async markEpisodesAsWatched(
    ...
    try {
      ...
      logger.log(
        `[WatchedService] Marking ${episodes.length} episodes as watched for ${showImdbId}`
      );
  ...
  public async markSeasonAsWatched(
    ...
    try {
      ...
      if (isTraktAuth) {
        ...
        syncedToTrakt = await this.traktService.markSeasonAsWatched(showImdbId, season, watchedAt);
  ...
  public async unmarkMovieAsWatched(
    ...
    try {
      ...
      const watchedKey = profile_id
        ? `watched:movie:${imdbId}:${profile_id}`
  ...
  public async unmarkEpisodeAsWatched(
    ...
    try {
      logger.log(
        `[WatchedService] Unmarking episode as watched: ${showImdbId} S${season}E${episode}`
      );
  ...
  public async unmarkSeasonAsWatched(
    ...
    try {
      ...
      if (isTraktAuth) {
        ...
        syncedToTrakt = await this.traktService.removeSeasonFromHistory(showImdbId, season);
