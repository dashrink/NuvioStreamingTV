 ...
 * ThemeScreen.tv.tsx
 *
 * TV-specific theme settings screen with complete D-pad navigation support.
 *
 * Features:
 * - Theme cards are focusable via D-pad navigation
 * - Category filter tabs are navigable
 * - Toggle switches work with the select button
 * - Focus memory persists when navigating between screens
 * - Back button returns to previous screen
 * - Theme editor is fully TV-navigable
 *
...
// TV-specific theme card with focusable wrapper
          ...
          {onDelete && (
            <Focusable
              ...
              animationConfig={{
                focusScale: 1.1,
                showFocusBorder: true,
                focusBorderColor: theme.colors.error,
                focusBorderWidth: 2,
              }}
...
// TV-specific filter tab component
...
// TV-specific theme color editor with D-pad navigation
const ThemeColorEditor: React.FC<ThemeColorEditorProps> = ({
  ...
  // Spatial navigation for editor
  const spatialNav = useSpatialNavigation('ThemeColorEditor', {
    autoRestoreFocus: true,
    defaultFocusId: 'editor-back',
  });
    ...
    <View style={styles.editorContainer}>
      <View style={styles.editorHeader}>
        <Focusable
          ...
          focusId="editor-back"
          onFocus={() => handleSettingFocus('editor-back')}
        >
          <MaterialIcons name="arrow-back" size={20} color="#FFFFFF" />
        </Focusable>
        <Focusable
          style={styles.editorTitleInputContainer}
          animationConfig={{
            focusScale: 1.02,
            showFocusBorder: true,
            focusBorderColor: currentTheme.colors.primary,
          ...
          focusId="editor-name"
          onFocus={() => handleSettingFocus('editor-name')}
        >
          <TextInput
        ...
        <Focusable
          ...
          focusId="editor-save"
          onFocus={() => handleSettingFocus('editor-save')}
        >
        ...
        <View style={styles.colorSectionRow}>
          ...
          <View style={styles.colorButtonsColumn}>
            <Focusable
              ...
              focusId="editor-color-primary"
              onFocus={() => handleSettingFocus('editor-color-primary')}
            >
            ...
            <Focusable
              ...
              focusId="editor-color-secondary"
              onFocus={() => handleSettingFocus('editor-color-secondary')}
            >
            ...
            <Focusable
              ...
              focusId="editor-color-background"
              onFocus={() => handleSettingFocus('editor-color-background')}
            >
...
const ThemeScreen: React.FC = () => {
  ...
  const spatialNav = useSpatialNavigation('ThemeScreen', {
    autoRestoreFocus: true,
    defaultFocusId: 'theme-back',
  });
    ...
    >
        ...
        <FlatList
          ...
          renderItem={({ item, index }) => (
            <FilterTab
              ...
              focusId={`filter-${item.id}`}
              onFocus={() => handleSettingFocus(`filter-${item.id}`)}
            />
          )}
      ...
      >
        ...
        <View style={styles.themeGrid}>
          {filteredThemes.map((theme, index) => (
            <ThemeCard
              ...
              onFocus={() => handleSettingFocus(`theme-${theme.id}`)}
            />
          ))}
        </View>
        ...
        <Focusable
          ...
          focusId="theme-create"
          onFocus={() => handleSettingFocus('theme-create')}
        >
        ...
        <Focusable
          ...
          focusId="theme-dominant-color"
          onFocus={() => handleSettingFocus('theme-dominant-color')}
          accessibilityLabel="Use Dominant Color from Artwork"
          accessibilityHint="Press to toggle this option"
        >
